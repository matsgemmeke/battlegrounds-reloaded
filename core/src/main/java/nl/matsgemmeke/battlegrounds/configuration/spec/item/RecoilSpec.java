 ...
 * @param kickbackDuration the duration in ticks of kickback movements caused by the recoil, will only be non-null when type equals to {@code CAMERA_MOVEMENT}
 * @param recoveryRate the amount of kickback recovery measured between 0-1, will only be non-null when type equals to {@code CAMERA_MOVEMENT}
 * @param recoveryDuration the duration in ticks of kickback recovery, will only be non-null when type equals to {@code CAMERA_MOVEMENT}
 */
