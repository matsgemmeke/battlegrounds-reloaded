...
public class PlayerKickEventHandler implements EventHandler<PlayerKickEvent> {
    ...
    @Inject
    public PlayerKickEventHandler(@NotNull GameContextProvider gameContextProvider, @NotNull GameScope gameScope, @NotNull Provider<PlayerLifecycleHandler> playerLifecycleHandlerProvider) {
