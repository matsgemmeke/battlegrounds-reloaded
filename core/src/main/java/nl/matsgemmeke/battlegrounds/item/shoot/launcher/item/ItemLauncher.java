...
public class ItemLauncher implements ProjectileLauncher {
    ...
    @Inject
    public ItemLauncher(AudioEmitter audioEmitter, @Assisted ItemEffect itemEffect, @Assisted ItemLaunchProperties properties) {
    ...
    public void launch(LaunchContext context) {
        ...
        audioEmitter.playSounds(properties.shotSounds(), dropLocation);
    }
