...
public class FlashEffect extends BaseItemEffect {
    ...
    @Inject
    public FlashEffect(FlashEffectPerformanceFactory flashEffectPerformanceFactory, GameContextProvider gameContextProvider, GameKey gameKey, GameScope gameScope) {
