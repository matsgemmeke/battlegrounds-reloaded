...
public class PlayerKickEventHandlerTest {
    ...
    public void handleDoesNothingWhenPlayerIsNotInAnyGameContext() {
        ...
        PlayerKickEventHandler eventHandler = new PlayerKickEventHandler(gameContextProvider, gameScope, playerLifecycleHandlerProvider);
    ...
    public void handleThrowsEventHandlingExceptionWhenNoGameContextExistsForGameKeyOfPlayer() {
        ...
        assertThatThrownBy(() -> eventHandler.handle(event))
                ...
                .hasMessage("Unable to process PlayerKickEvent for game key FREEPLAY, no corresponding game context was found");
    }
