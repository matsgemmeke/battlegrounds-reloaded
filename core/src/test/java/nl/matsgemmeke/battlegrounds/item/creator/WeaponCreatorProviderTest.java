...
public class WeaponCreatorProviderTest {
    ...
    public void getThrowsIllegalStateExceptionWhenResourceLocationIsInvalidURI() throws URISyntaxException {
        ...
        WeaponCreatorProvider provider = spy(new WeaponCreatorProvider(equipmentFactory, gunFactory, specDeserializer, itemsFolder, logger));
    ...
    public void getLogsWarningsMessageWhenDirectoryDoesNotContainAnyFiles() {
        ...
        WeaponCreatorProvider provider = new WeaponCreatorProvider(equipmentFactory, gunFactory, specDeserializer, itemsFolder, logger);
        provider.get();
